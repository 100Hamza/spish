...
class BarChartBody extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => BarChartBodyState();
}

class BarChartBodyState extends State<BarChartBody> {
  ...
  void initState() {
    ...
    final barGroup3 = makeGroupData(2, 18, 19);
  ...
  Widget bottomTitles(double value, TitleMeta meta) {
    final titles = <String>['Silver', 'Diamond', 'Gold'];
